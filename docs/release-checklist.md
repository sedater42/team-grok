...
- [ ] Negative smokes reject API env/config, symlinks, secrets, overlaps, missing login, model downgrade, extensions, invalid usage, invalid receipts, and unsafe cleanup targets.
